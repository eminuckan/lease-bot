...
test("builds observability payload with core metrics and recent feeds", async () => {
  ...
  assert.equal(client.calls[5].params[1].includes("workflow_no_reply_recovered"), true);
  ...
  assert.equal(client.calls[6].params[1].includes("workflow_no_reply_recovered"), true);
  ...
  assert.equal(client.calls[7].params[1].includes("workflow_no_reply_recovered"), true);
